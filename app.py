...
def init_db():
    ...
    ('Phishing & Credential Theft', 
     ...
     '<h4>Objective</h4><p>Execute a complete phishing attack chain from reconnaissance to lateral movement. You are targeting company.com employees.</p><h4>What You Will Learn</h4><ul><li>Network scanning with <code>nmap</code></li><li>Social engineering email crafting with <code>setoolkit</code></li><li>Website cloning with <code>httrack</code></li><li>Credential harvesting techniques</li></ul><h4>Real-World Context</h4><p>The 2020 Twitter hack used social engineering to gain internal access. Phishing remains the #1 initial access vector in 91% of cyber attacks. Attackers prey on human psychology rather than technical flaws, making it incredibly effective. Training employees to recognize these deceptive tactics is a critical first line of defense.</p>'))
